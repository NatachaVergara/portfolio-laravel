   ...
   <section id="about" class="about">
       <div class="container d-flex flex-column justify-content-center align-items-center">
           ...
           <div class="row">
               <div class="col col-lg-4 mt-md-5">
                   <img src="assets/img/IMG-20190730-WA0011.jpg" class="img-fluid" alt="">
               </div>
               <div class="col col-lg-8 pt-4 pt-lg-0 content">
                   <h3>Web Developer.</h3>
                   <p class="font-italic">
                       ...
                       <div class="col col-lg-7">
                           <ul>
                               <li><i class="icofont-rounded-right"></i>
                                   <strong>Website:</strong>www.natachavergara.com.ar
                               </li>
                               <li><i class="icofont-rounded-right"></i> <strong>Email:</strong> ntchvergara@gmail.com
                               </li>
                               <li><i class="icofont-rounded-right"></i> <strong>Age:</strong> 36</li>
                               <li><i class="icofont-rounded-right"></i> <strong>Degree:</strong> Junior</li>
